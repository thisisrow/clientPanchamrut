    ...
    <main>
      <section className="relative h-[600px] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div data-aos="zoom-in-right" className="max-w-2xl text-white">
      ...
      <section data-aos="fade-up" className=" py-12 -mt-16 relative z-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
              ...
              className="bg-white p-8 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 flex items-start gap-4"
            >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div data-aos="fade-right" className="lg:w-1/2 relative">
              ...
              <div
                ...
                data-aos-easing="linear"
                data-aos-duration="1000"
                className="absolute -bottom-8 -right-8 bg-[#15803d] text-white p-8 rounded-2xl shadow-xl z-20 max-w-[240px] "
              >
